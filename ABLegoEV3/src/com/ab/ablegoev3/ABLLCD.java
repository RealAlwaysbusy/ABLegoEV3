...
public class ABLLCD {
     ...
     */
    public static void DrawString2(String str, int x, int y, boolean inverted)
    {
     ...
     * @param y The y character co-ordinate to display at.
     */
    public static void DrawInt2(int i, int places, int x, int y)
    {
     ...
     */
    public static void Clear3(int x, int y, int n) {
        LCD.clear();
    }
     ...
     */
    public static void Clear2(int y) {
        LCD.clear(y);
    }
